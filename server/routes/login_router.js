...
router.post('/login', (req,res) => {
   ...
   // res.end("Login Successful..!");
      ...
      res.render('login_base', { title : "Login System", errorMessage: "Invalid Username or Password"});
...
router.get('/dashboard', (req,res) => {
   ...
   if(req.session.user && req.session.user_role == "admin"){
      ...
      res.render('login_base', { title : "Login System", errorMessage: "Unauthorize User"});
   }
})
...
router.get('/logout', (req,res) => {
   req.session.destroy(function(err){
      if(err){
         ...
         res.render('login_base',{title: "Express", logout:"Logout Successfully..!"})
      }
   })
})
